 ...
 * @author Dridi
 */
public class ProduitBlob extends javax.swing.JFrame {
...
//                System.out.println(imagePath +"   Get Res : " +getClass().getResource(imagePath));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProduitBlob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProduitBlob().setVisible(true);
            }
        });
