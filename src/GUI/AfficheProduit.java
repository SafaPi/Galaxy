 ...
 * @author Dridi
 */
public class AfficheProduit extends javax.swing.JFrame {

    /**
     * Creates new form AfficheProduit
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficheProduit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AfficheProduit().setVisible(true);
            }
        });
    }
