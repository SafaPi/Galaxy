 ...
 * @author Dridi
 */
public class validerBlob extends javax.swing.JFrame {
    ...
    public validerBlob() {
        ...
        coucheMetier pubDAO = new coucheMetier();
        List<Produit> pubs = new ArrayList<>();
        Produit p = new Produit();
        pubs = pubDAO.findNonValid();
    ...
    private void AfficheImages() {
      ...
      pnl_detail.removeAll();
        ...
        prod = produitMetier.findNonValid();
        for (Produit p : prod) {
            itemImage.add(p.getNom());
            categorie.add(p.getCategorie_id());
...
//                System.out.println(imagePath +"   Get Res : " +getClass().getResource(imagePath));
           ...
           buttons[i] = new JButton("", icon);
            ...
            buttons[i].addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                   // if(user1.getId()==1){
                        ProduitDisplay mdf = new ProduitDisplay();
                        mdf.setVisible(true);
    ...
    private void initComponents() {
        ...
        pnl_detail.add(jScrollBar3, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 10, -1, 380));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(validerBlob.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new validerBlob().setVisible(true);
            }
        });
